...
//     modalTitle.textContent = "Blaise Pascal: A Brilliant Mind in Science and Mathematics";
//     modalBody.innerHTML = `
//       <p>Blaise Pascal (1623–1662) was a French mathematician, physicist, inventor, and philosopher whose contributions have greatly shaped modern science and mathematics. Born in Clermont-Ferrand, France, Pascal showed exceptional intelligence from a young age. By the time he was just 16, he had already written a significant work on projective geometry, which demonstrated his understanding of complex mathematical ideas. His innovative thinking extended beyond mathematics as he also explored natural sciences and made groundbreaking discoveries in fluid mechanics and pressure.</p>

// <p>One of Pascal's most notable inventions was the Pascaline, an early mechanical calculator. This device, capable of performing basic arithmetic operations like addition and subtraction, was designed to assist his father, who was a tax collector. In the field of physics, Pascal’s experiments on liquids and gases led to the discovery of Pascal's Law, which states that pressure exerted on a confined fluid is transmitted evenly in all directions. This principle remains essential in engineering and is used in hydraulic systems like car brakes and elevators.</p>

// <p>Later in life, Pascal shifted his focus to philosophy and theology, where he explored deeper questions about existence, faith, and human nature. His famous work, Pensées, is a collection of thoughts that reflect his beliefs and understanding of life’s complexities. Despite his short life of just 39 years, Blaise Pascal’s contributions continue to influence various fields, from mathematics and science to philosophy. He is remembered not only for his brilliance but also for his ability to connect the abstract world of ideas with practical applications.</p>
//     `;
  } 
